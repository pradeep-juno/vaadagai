      ...
      body: Column(
        ...
        children: [
              ...
              Row(
                ...
                children: [
                  Positioned(
                    ...
                    }, fontColor: AppColors.orange, height: 40, width: 90),
                  ),
          ...
          Padding(
            ...
            child: buildTextFun(
                context, AppConstants.onBoardingScreenTwoDescriptionFirst,
                fontSize: 24,
                fontWeight: FontWeight.w500,
          ...
          Padding(
              padding: const EdgeInsets.symmetric(horizontal: 25),
              child: buildTextFun(
                  context, AppConstants.onBoardingScreenTwoDescriptionSecond,
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
